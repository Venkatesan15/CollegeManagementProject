...
public class StudentsTL {
    static StudentsTL studentsTLObj;
    private StudentsTL()
    {

    }
    public static StudentsTL getStudentsTLObj()
    {
        if(studentsTLObj==null)
        {
            studentsTLObj=new StudentsTL();
        }
        return studentsTLObj;
    }
