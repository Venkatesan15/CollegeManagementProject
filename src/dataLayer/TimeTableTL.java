...
public class TimeTableTL {
    static TimeTableTL timeTableTLObj;
    private TimeTableTL()
    {

    }
    public static TimeTableTL getTimeTableTLObj()
    {
        if(timeTableTLObj==null)
        {
            timeTableTLObj=new TimeTableTL();
        }
        return timeTableTLObj;
    }
